...
class Models(_api_module.BaseModule):
  ...
  def generate_content(
    ...
    - the Gemini model ID, for example: 'gemini-3-flash-002'
    - the full resource name starts with 'projects/', for example:
      'projects/my-project-id/locations/us-central1/publishers/google/models/gemini-3-flash-002'
    - the partial resource name with 'publishers/', for example:
      'publishers/google/models/gemini-3-flash-002' or
      'publishers/meta/models/llama-3.1-405b-instruct-maas'
    - `/` separated publisher and model name, for example:
      'google/gemini-3-flash-002' or 'meta/llama-3.1-405b-instruct-maas'

    For the `model` parameter, supported format for Gemini API includes:
    - the Gemini model ID, for example: 'gemini-3-flash-002'
    - the model name starts with 'models/', for example:
      'models/gemini-3-flash-002'
